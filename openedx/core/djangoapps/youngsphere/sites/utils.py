...
def get_branding_values_from_file():
    ...
    print("site_theme:", site_theme)
    print("dir:",site_theme.theme_dir_name)
    theme = Theme(
...
def bootstrap_site(site, org_data=None, user_email=None):
    ...
    if organization_slug:
        ...
        if site_config.values == "":

            values = {"course_org_filter": organization_slug}
            site_config.values = values
            site_config.save()
                        ...
                        "column-1": [
                            ...
                            },
                            {
                                ...
                                "options": {
                                    ...
                                    "margin-top": "marg-t-5",
                                    "margin-left": "marg-l-0",
                                    "text-content": "Welcome to your Youngsphere powered Open edX site! ",
                        ...
                        "column-1": [
                            ...
                            },
                            {
                                ...
                                "options": {
                                    ...
                                    "margin-top": "marg-t-30",
                                    "margin-left": "marg-l-0",
                                    "text-content": "Youngsphere is an edX partner and Open edX service provider and contributor. We provide custom Open edX development, implementation, integration, managed hosting, support and training, as well as advanced Open edX services such as SCORM support and Virtual Software Labs. ",
                                    "font-family": "font--primary--light",
                                    "text-alignment": "text-align--center"
                                }
                            },
